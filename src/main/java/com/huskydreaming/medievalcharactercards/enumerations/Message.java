...
public enum Message implements Parseable {
    ...
    GENERAL_SET_HEIGHT("You have successfully set your height to &f<0>"),
    ...
    GENERAL_VALID_MIN("Your <0> must be at least <1>"),
    GENERAL_VALID_MAX("Your <0> must be less than <1>"),
    GENERAL_VALID_MIN_CHAR("Your <0> must be at least <1> character(s)"),
    GENERAL_VALID_MAX_CHAR("Your <0> must be less than <1> character(s)"),
